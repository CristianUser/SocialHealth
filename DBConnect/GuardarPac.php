...
if(!empty($_POST))
{
    $nss = $mysqli->real_escape_string($_POST['nss']);	
    $seguro = $mysqli->real_escape_string($_POST['seguro']);
    ...
    if(registraDatosPac($id, $seguro, $nss, $nacimiento, $sexo, $telefono, $cedula, $provincia, $direccion)){
