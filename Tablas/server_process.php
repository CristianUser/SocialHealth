<?php
	...
	$aColumnas = array( 'id_usuario', 'nombre', 'correo', 'usuario' );
	...
	//Filtracion
	$sWhere = "WHERE USR.id_usuario in (SELECT ID_Cliente FROM r_paciente WHERE ID_Profesional = 4)";
	if ( $_GET['sSearch'] != "" )
	{
		$sWhere = "WHERE (";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a class='btn btn-primary' href='modificar.php?id=".$aRow['id_usuario']."'>edit</a></td>";
		$row[] = "<td><a class='btn btn-danger' href='#' data-href='eliminar.php?id=".$aRow['id_usuario']."' data-toggle='modal' data-target='#confirm-delete'>delete</a></td>";
